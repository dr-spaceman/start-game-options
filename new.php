...
if($_POST) require("new-process.php");

$page->title = "Videogam.in / News / Post Item";
...
if(!$usrid) dieFullPage('Please <a href="javascript:void(0)" onclick="toggle(\'login\')">log in</a> to post a new item.');

$sessid = ($in['sessid'] ? $in['sessid'] : date("YmdHis")."_".rand(100,999));
...
<div class="h">
	...
	<ul class="tabbed-nav">
		<li><a href="#" rel="text">Text</a></li>
		<li><a href="#" rel="quote">Quote</a></li>
		<li><a href="#" rel="link">Link</a></li>
		<li><a href="#" rel="image">Image</a></li>
		<li><a href="#" rel="gallery">Gallery</a></li>
		<li><a href="#" rel="video">Video</a></li>
		<li><a href="#" rel="audio">Audio</a></li>
	</ul>
</div>
<br style="clear:both"/>
...
<form action="new.php" method="post" enctype="multipart/form-data" onsubmit="return checkNNform();"<?=(!$_POST['submit_new'] ? ' style="display:none"' : '')?>>
	...
	<div id="form-text" class="forms"<?=($in['type'] != "text" ? ' style="display:none"' : '')?>>
		<table border="0" cellpadding="0" cellspacing="0" class="styled-form">
			...
			<tr>
				...
				<td>
					...
					<p><a href="#_headline_img" class="arrow-toggle" onclick="$(this).toggleClass('arrow-toggle-on').parent().next().slideToggle();">Headline Image</a></p>
					<div style="display:none">
						<p>
							<img src="/bin/img/news_headline_img.png" alt="Headline img" style="float:left; margin:3px 10px 0 0;"/>
							Upload an accompanying headline image:<br/>
							<span style="color:#888;">JPG, GIF, or PNG format; Image will be resized to 100 x 100 pixels.</span>
							<p><input type="file" name="headline_img_text"/></p>
						</p>
					</div>
					<p><a href="#_expanded_article" class="arrow-toggle" onclick="$(this).toggleClass('arrow-toggle-on').parent().next().toggle();">Expanded Article</a></p>
					<div style="display:none">
	...
	<div id="form-quote" class="forms"<?=($in['type'] != "quote" ? ' style="display:none"' : '')?>>
	...
	<div id="form-link" class="forms"<?=($in['type'] != "link" ? ' style="display:none"' : '')?>>
		<table border="0" cellpadding="0" cellspacing="0" class="styled-form">
			<tr>
				<th>URL</th>
				<td><input type="text" name="in[link][url]" value="<?=($in['link']['url'] ? htmlSC($in['link']['url']) : 'http://')?>" size="100" tabindex="5" style="color:blue; text-decoration:underline;" onfocus="if($(this).val()=='http://') $(this).val('');"/></td>
			</tr>
			<tr>
				<th>Link Text</th>
				...
				<td>
					...
					<div style="display:none">
						<p>
							...
							Upload an accompanying headline image:<br/>
							<span style="color:#888;">JPG, GIF, or PNG format; Image will be resized to 100 x 100 pixels.</span>
							<p><input type="file" name="headline_img_link"/></p>
						</p>
					</div>
				</td>
			</tr>
	...
	<div id="form-image" class="forms"<?=($in['type'] != "image" ? ' style="display:none"' : '')?>>
		<table border="0" cellpadding="0" cellspacing="0" class="styled-form">
			<tr>
	...
	<div id="form-gallery" class="forms"<?=($in['type'] != "gallery" ? ' style="display:none"' : '')?>>
		<table border="0" cellpadding="0" cellspacing="0" class="styled-form">
			<tr>
				<th>Heading<br/><small>Optional</small></th>
	...
	<div id="form-video" class="forms"<?=($in['type'] != "video" ? ' style="display:none"' : '')?>>
		<table border="0" cellpadding="0" cellspacing="0" class="styled-form">
			<tr>
				<th>Heading<br/><small>Optional</small></th>
	...
	<div id="form-audio" class="forms"<?=($in['type'] != "audio" ? ' style="display:none"' : '')?>>
		<table border="0" cellpadding="0" cellspacing="0" class="styled-form">
			<tr>
				<th>Source</th>
				<td>
				...
				<td>
					...
					<div style="display:none">
						<p>
							...
							Upload an accompanying headline image:<br/>
							<span style="color:#888;">JPG, GIF, or PNG format; Image will be resized to 100 x 100 pixels.</span>
							<p><input type="file" name="headline_img_audio"/></p>
						</p>
					</div>
				</td>
			</tr>
